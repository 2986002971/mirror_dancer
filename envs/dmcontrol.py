...
class GymnasiumAdapter(gym.Env):
    """Adapter to make TimeStepToGymWrapper compatible with gymnasium.Env"""

    def __init__(self, env):
        self.env = env
        self.observation_space = env.observation_space
        self.action_space = env.action_space
        self.max_episode_steps = getattr(env, "max_episode_steps", 1000)
    ...
    def step(self, action):
        ...
        # For gymnasium compatibility, assume done means terminated
